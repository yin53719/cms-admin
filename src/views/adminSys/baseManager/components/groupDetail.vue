...
<el-row>
  ...
  <el-col :span="8" style='margin-top:15px;'>
    ...
    <el-tree class="filter-tree" style="border:1px solid #d1dbe5;" :data="treeData" node-key="id" highlight-current :props="defaultProps" :filter-node-method="filterNode" ref="groupTree" @node-click="getNodeData" default-expand-all> </el-tree>
  </el-col>
