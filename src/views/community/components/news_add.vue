      ...
      <el-form ref="form" :model="form" label-width="80px" :rules="rules" >
        ...
        <el-col :span="24">
            <el-form-item label="资讯模板" prop="contentType">
                <el-radio v-model="form.contentType" :label="1">图文</el-radio>
                <el-radio v-model="form.contentType" :label="3">图片</el-radio>
                <el-radio v-model="form.contentType" :label="4">视频</el-radio>
            </el-form-item>
        </el-col>
        </el-row>
        <el-row>
            <el-form-item label=""  v-show="form.contentType==1">
                <div :id="editor" type="text/plain" style="line-height:20px;height:250px;width:500px;"></div>
            </el-form-item>
            <el-form-item label="" v-if="form.contentType==3" prop="content">
                <el-col v-for="(x,i) in form.photoList" :key="i" style="position:relative;">
                  <el-upload
                            ...
                            :before-upload="beforeAvatarUpload">
                            <img v-if="x.url" :src="x.url" class="avatar-my">
                ...
                <el-col><el-button @click="addPhotos">点击添加</el-button></el-col>
            </el-form-item>
            ...
            <el-col :span='24'>
              <el-form-item label="">
                <el-checkbox v-model="form.isFullpush">全站推送</el-checkbox>
                <el-checkbox v-model="form.isShow">是否显示</el-checkbox>
              </el-form-item>
            </el-col>
            <el-col :span='24'>
            <el-form-item label="排序" style="width:100%">
                <el-select v-model="form.sort" placeholder="请选择" style="width:200px;">
                <el-option
...
export default {
    ...
    data(){
      ...
      updateStatus:"",
      editStatus:"",
      saveUrl:'/community/news/insertNews'
      }
    },
  created() {
    request({
  ...
  methods: {
    ...
    save(t,ts){
      ...
      if(data.contentType==1){
         ...
         data['content']=JSON.stringify(this.form.photoList);
          if (!this.form.photoList[0].url || this.form.photoList[0].url=='') {
      ...
      set.form.validate((valid) => {
        if(valid){
          request({
                ...
                if(ts==3){
                  let id= this.form.id;
                  this.iframeUrl=location.origin+'/saicui/preview?id='+id+'&type='+type;
